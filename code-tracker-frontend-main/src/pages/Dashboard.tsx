...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      {/* User Info */}
      <div className="bg-black/60 p-6 rounded-lg shadow-md border border-blue-400/30">
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-blue-200">Contribution: {user.contribution}</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Rating Information */}
          <div className="bg-black/40 p-4 rounded-lg border border-blue-400/20">
            <h3 className="text-lg font-semibold mb-4 text-blue-300">Rating Info</h3>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-blue-200">Current Rating</span>
                <span className="text-xl font-bold" style={{ color: getRatingColor(user.rating) }}>
                  {user.rating}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-blue-200">Max Rating</span>
                <span className="text-xl font-bold" style={{ color: getRatingColor(user.maxRating) }}>
                  {user.maxRating}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-blue-200">Rating Rank</span>
                <span className="text-xl font-bold" style={{ color: getRatingColor(user.rating) }}>
                  #{user.rank}
                </span>
              </div>
          ...
          <div className="bg-black/40 p-4 rounded-lg border border-green-400/20">
            <h3 className="text-lg font-semibold mb-4 text-green-300">Problem Solving Stats</h3>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-green-200">Total Solved</span>
                <span className="text-xl font-bold text-green-400">
                  {uniqueProblemsSolved}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-green-200">Max Difficulty</span>
                <span className="text-xl font-bold text-orange-400">
                  {maxRating}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-green-200">Avg. Difficulty</span>
          ...
          {/* Contest History */}
          <div className="bg-black/40 p-4 rounded-lg border border-purple-400/20">
            <h3 className="text-lg font-semibold mb-4 text-purple-300">Contest History</h3>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-purple-200">Total Contests</span>
                <span className="text-xl font-bold" style={{ color: getRatingColor(user.rating) }}>
              ...
              <div className="flex justify-between items-center">
                <span className="text-purple-200">Last Contest</span>
          ...
          <div className="bg-black/40 p-4 rounded-lg border border-cyan-400/20">
            <h3 className="text-lg font-semibold mb-4 text-cyan-300">Activity Stats</h3>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-cyan-200">Total Submissions</span>
                <span className="text-xl font-bold text-cyan-400">
                  {submissions.length}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-cyan-200">Accepted Rate</span>
      ...
      <div className="bg-black/60 p-6 rounded-lg shadow-md border border-blue-400/30">
        <h3 className="text-xl font-semibold mb-4 text-blue-300">Problems Solved (Last 45 Days)</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div className="p-4 bg-black/40 rounded-lg border border-blue-400/20">
            <p className="text-sm text-blue-200">Total Problems Solved</p>
          ...
          <div className="p-4 bg-black/40 rounded-lg border border-green-400/20">
            <p className="text-sm text-green-200">Total Submissions</p>
          ...
          <div className="p-4 bg-black/40 rounded-lg border border-purple-400/20">
            <p className="text-sm text-purple-200">Average Daily Problems</p>
      ...
      {/* Submission Verdicts */}
      <div className="bg-black/60 p-6 rounded-lg shadow-md border border-blue-400/30">
        <h3 className="text-xl font-semibold mb-4 text-blue-300">Submission Verdicts</h3>
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <div className="bg-black/60 p-6 rounded-lg shadow-md border border-blue-400/30">
          <h3 className="text-xl font-semibold mb-4 text-blue-300">Problem Ratings</h3>
          <ResponsiveContainer width="100%" height={400}>
        ...
        <div className="bg-black/60 p-6 rounded-lg shadow-md border border-blue-400/30">
          <h3 className="text-xl font-semibold mb-4 text-blue-300">Problem Types Distribution</h3>
